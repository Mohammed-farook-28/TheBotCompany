                    ...
                    <div className="relative z-20 grid grid-cols-6 gap-2 sm:gap-3">
                        ...
                        <SpotlightCard className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                ...
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="text-base sm:text-lg font-medium transition text-white">Secure by Default</h2>
                        ...
                        <SpotlightCard className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                <div className="pt-6 lg:px-6">
                                    <svg className="w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <g clipPath="url(#clip0_0_106)">
                                            ...
                                            <path d="M29 23V35" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                            <path d="M35 29L29 35L23 29" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                            <text x="55" y="30" fill="white" fontSize="14" fontFamily="Arial, sans-serif" fontWeight="500">Download</text>
                                            <text x="268" y="30" fill="white" fontSize="14" fontFamily="Arial, sans-serif" fontWeight="500">14,34 mbps</text>
                                        </g>
                                        <path
                                            fillRule="evenodd"
                                            clipRule="evenodd"
                                ...
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-base sm:text-lg font-medium transition text-white">Real-Time Processing</h2>
                            ...
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-[#ffffff]/30 before:absolute before:-inset-2 before:rounded-full before:border before:border-[#ffffff]/20">
                                        <Shield className="m-auto size-5 text-[#ffffff]" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-base sm:text-lg font-medium text-white transition">Smart Analytics</h2>
                                        <p className="text-white/60 text-sm sm:text-base">Advanced insights and predictive analytics to drive better decisions.</p>
                                    </div>
                                </div>
                        ...
                        <SpotlightCard className="relative col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-[#ffffff]/30 before:absolute before:-inset-2 before:rounded-full before:border before:border-[#ffffff]/20">
                                        <Users className="m-auto size-6 text-[#ffffff]" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-base sm:text-lg font-medium transition text-white">Seamless Collaboration</h2>
                                        <p className="text-white/60 text-sm sm:text-base">Teams work better together with AI-powered workflow automation.</p>
                                    </div>
                                </div>
                                <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Stefan</span>
                                            <div className="ring-background size-7">
                                                <img className="size-full rounded-full" src="/avatar-stefan.jpg" alt="Stefan" />
                                            </div>
                                        </div>
                                        <div className="relative  flex items-center gap-2">
                                            <div className="ring-background size-8 ">
                                                <img className="size-full rounded-full" src="/avatar-dameon.jpg" alt="M. Dameon" />
                                            </div>
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">M. Dameon</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">B. Elijha</span>
                                            <div className="ring-background size-7 ">
                                                <img className="size-full rounded-full" src="/avatar-elijha.jpg" alt="B. Elijha" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
